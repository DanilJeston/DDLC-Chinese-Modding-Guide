...
\begin{Attention}
    在使用资源前，请务必注意版权问题。一般来说，在DDLC Community Assets中的文件只需要在感谢名单中添加作者的名字，但也有部分资源会有更多的要求。请记住：一个资源如果作者没有放弃对其的所有权，那么没有得到授权就使用该资源的行为是侵权违法行为。保护作者的知识产权，不仅是在维护作者的权利、保护作者的心血，更是保护创造、促进DDLC社区的良好发展。
\end{Attention}
